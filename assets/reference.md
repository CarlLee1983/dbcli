...
- A path whose text routes somewhere other than it spells (`%2F`, `..`) is refused outright, whether or not a blacklist is configured. A quoted string request body is refused; write the body as JSON.
