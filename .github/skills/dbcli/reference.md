...
- Cursor's plugin-style path is instruction-file based rather than marketplace based; see `plugins/dbcli-agent/INSTALL.md#cursor` for clone/copy and local installer options.
