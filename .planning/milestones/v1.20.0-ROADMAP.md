# Roadmap: dbcli — Milestone v1.20.0 Agent-Facing Audit Log (ARCHIVED)

**Archived:** 2026-05-17 — milestone shipped; all 6 phases complete (29 plans). Phase 23 partial — `insert/update/delete/export/q/schema` audit wiring deferred to Phase 23-04 in the next milestone backlog.
**Created:** 2026-05-14
