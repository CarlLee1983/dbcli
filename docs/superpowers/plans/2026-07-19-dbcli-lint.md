...
// 1. Walk projection, JOIN ON, WHERE, and HAVING expressions in every nested
//    SELECT/CTE/derived statement, preserving each statement's own scope, for
//    binary_expr nodes whose operator is NOT IN.
